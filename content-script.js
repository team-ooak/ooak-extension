...
// 4. 스위치 on/off
const EMOTE_LINK =
  "https://gateway.pinata.cloud/ipfs/QmagcKVZVySuAL75dqy3jMwamQJ3KaV4YG9Ck1SCR3hX6o";

const ID_TAG_LINK = chrome.runtime.getURL(
  "public/assets/icons/ooak-id-tag-icon.png"
);
...
const chattingObserver = new MutationObserver(function (mutations) {
  mutations.forEach((mutation) => {
    ...
    const userDataContainer = newChatContainer.querySelector(
    ...
    if (chatLineContainer) {
      ...
      const usernameContainer = newChatContainer.querySelector(
      ...
      if (message === "_OOAK") {
        ...
        emoteContainer.class =
          "Layout-sc-nxg1ff-0 kqafdi chat-image__container";
